  ...
  "questions": [
    {
      ...
      "list1": ["Item 1", "Item 2", "Item 3", "Item 4"], // for match-column, otherwise empty array
      "list2": ["Item 1", "Item 2", "Item 3", "Item 4"], // for match-column, otherwise empty array
      "list1Header": "Header 1", // for match-column, otherwise empty string
      "list2Header": "Header 2", // for match-column, otherwise empty string
